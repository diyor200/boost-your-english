...
@quiz_router.message(VocabularyTraining.BookTitle)
async def begin_registration(message: types.Message, state: FSMContext):
...
@quiz_router.message(VocabularyTraining.TestNumber)
async def begin_registration(message: types.Message, state: FSMContext):
...
@quiz_router.message(VocabularyTraining.PassageNumber)
async def begin_registration(message: types.Message, state: FSMContext):
    data = await state.get_data()
...
@quiz_router.message(VocabularyTraining.Word)
async def begin_registration(message: types.Message, state: FSMContext):
    data = await state.get_data()
    index = data["index"]
    words = data["words"]
...
@quiz_router.message(Command("inline"))
async def new_word(message: types.Message, state: FSMContext):
